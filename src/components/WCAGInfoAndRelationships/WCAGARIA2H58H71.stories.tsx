...
import WCAGARIA2H58H71 from './WCAGARIA2H58H71'

const metaARIA2H71: Meta<typeof WCAGARIA2H58H71> = {
    component: WCAGARIA2H58H71,
    tags: ['autodocs'],
    parameters: {
        docs: {
            page: () => (
...
type StoryARIA2H71 = StoryObj<typeof WCAGARIA2H58H71>

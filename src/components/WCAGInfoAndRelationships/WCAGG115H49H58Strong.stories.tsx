...
import WCAGG115H49H58Strong from './WCAGG115H49H58Strong'

const metaG115H49Strong: Meta<typeof WCAGG115H49H58Strong> = {
    component: WCAGG115H49H58Strong,
    tags: ['autodocs'],
    parameters: {
        docs: {
            page: () => (
                    ...
                    <Subtitle>
                        ...
                        <p>
                            <strong>
                                ...
                                semantic elements, in this case: the strong
...
type StoryG115H49Strong = StoryObj<typeof WCAGG115H49H58Strong>
...
export const Strong: StoryG115H49Strong = {
    render: () => (
        <div>
            Hello, my name is&nbsp;
            <WCAGG115H49H58Strong>Michael Smith</WCAGG115H49H58Strong>.
        </div>
    ),
}

export const StrongWithSpan: StoryG115H49Strong = {
    render: () => (
        <div>
            Hello, my name is&nbsp;
            <WCAGG115H49H58Strong>
...
export const Number: StoryG115H49Strong = {
    render: () => <WCAGG115H49H58Strong>{25}</WCAGG115H49H58Strong>,
}

export const Boolean: StoryG115H49Strong = {
    render: () => <WCAGG115H49H58Strong>{false}</WCAGG115H49H58Strong>,
}

...
import WCAGG115H49H58Sub from './WCAGG115H49H58Sub'

const metaG115H49Sub: Meta<typeof WCAGG115H49H58Sub> = {
    component: WCAGG115H49H58Sub,
    tags: ['autodocs'],
    parameters: {
        docs: {
            page: () => (
                    ...
                    <Subtitle>
                        ...
                        <p>
                            <strong>
                                ...
                                semantic elements, in this case: the sub
...
type StoryG115H49Sub = StoryObj<typeof WCAGG115H49H58Sub>
...
export const Sub: StoryG115H49Sub = {
    render: () => (
        <div>
            Hello, my name is{' '}
            <WCAGG115H49H58Sub>Michael Smith</WCAGG115H49H58Sub>.
        </div>
    ),
}

export const SubWithSpan: StoryG115H49Sub = {
    render: () => (
        <div>
            Hello, my name is{' '}
            <WCAGG115H49H58Sub>
...
export const Number: StoryG115H49Sub = {
    render: () => <WCAGG115H49H58Sub>{25}</WCAGG115H49H58Sub>,
}

export const Boolean: StoryG115H49Sub = {
    render: () => <WCAGG115H49H58Sub>{false}</WCAGG115H49H58Sub>,
}

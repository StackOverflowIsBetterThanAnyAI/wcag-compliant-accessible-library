...
export const Number: StoryG115H49Em = {
    render: () => (
        <div>
            Hello, my name favourite number is{' '}
            <WCAGG115H49H58Em>{25}</WCAGG115H49H58Em>!
        </div>
    ),
}

export const Boolean: StoryG115H49Em = {
    render: () => <WCAGG115H49H58Em>{false}</WCAGG115H49H58Em>,
}

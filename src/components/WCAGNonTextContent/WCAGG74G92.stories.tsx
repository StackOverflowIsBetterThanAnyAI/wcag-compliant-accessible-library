                ...
                <>
                    ...
                    <Subtitle>
                        ...
                        <p>
                            ...
                            which is set in the <strong>WCAGG74G92</strong>{' '}
                            component. In the <strong>WCAGG74G92</strong>{' '}
                        ...
                        <p>
                            ...
                            <strong>WCAGG74G92</strong> component, which allows
                        ...
                        <div>
                            ...
                            the <strong>WCAGG74G92</strong> component. You can
                            use the following WAI-ARIA attributes, but without
                            the 'aria-' prefix. But be careful: You cannot use
                            every WAI-ARIA attribute with every WAI-ARIA role!
                            <table
                                style={{
                                    margin: '2% auto',
                                    backgroundColor: '#e9e9e9',
                        ...
                        <p>
                            As the <strong>WCAGG74G92Text</strong> components
                        ...
                        <p>
                            You can also add an optional customised{' '}
                            <strong>className: string</strong> to your{' '}
                            <strong>WCAGG74G92Text</strong> component, which

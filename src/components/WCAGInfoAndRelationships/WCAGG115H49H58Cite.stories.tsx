...
import WCAGG115H49H58Cite from './WCAGG115H49H58Cite'

const metaG115H49Cite: Meta<typeof WCAGG115H49H58Cite> = {
    component: WCAGG115H49H58Cite,
    tags: ['autodocs'],
    parameters: {
        docs: {
            page: () => (
...
type StoryG115H49Cite = StoryObj<typeof WCAGG115H49H58Cite>

// WCAGG115H49H58Cite

export const Cite: StoryG115H49Cite = {
    render: () => <WCAGG115H49H58Cite>Michael Smiths, 1999</WCAGG115H49H58Cite>,
}

export const CiteWithSpan: StoryG115H49Cite = {
    render: () => (
        <WCAGG115H49H58Cite>

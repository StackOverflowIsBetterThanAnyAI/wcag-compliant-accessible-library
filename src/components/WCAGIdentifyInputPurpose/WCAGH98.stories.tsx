...
import WCAGH98 from './WCAGH98'

const metaWCAGH98: Meta<typeof WCAGH98> = {
    component: WCAGH98,
    tags: ['autodocs'],
    parameters: {
        docs: {
                ...
                <>
                    ...
                    <Subtitle>
                        <strong>
                            ...
                            element inside a form container.
                        </strong>
                        <p>
...
export default metaWCAGH98

type StoryWCAGH98 = StoryObj<typeof WCAGH98>

// WCAGIdentifyInputPurposeWCAGH98

export const StringInput: StoryWCAGH98 = {
    render: () => (
        <WCAGH98
...
export const SpanLabelText: StoryWCAGH98 = {
    render: () => (
        <WCAGH98
            formData={{ method: 'post', id: 'form' }}
            inputData={[
